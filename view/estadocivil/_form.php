...
<form id="frm_estadocivil" >
    <input type="hidden" name="controller" value="Estadocivil" />
    <input type="hidden" name="action" value="save" />
    
        <input type="hidden" id="idestado_civil" name="idestado_civil" value="<?php echo $obj->idestado_civil; ?>" />
