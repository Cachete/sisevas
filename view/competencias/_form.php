...
<form id="frm_competencias" >
    <input type="hidden" name="controller" value="competencias" />
    <input type="hidden" name="action" value="save" />   
    <input type="hidden" id="idcompetencia" name="idcompetencia" value="<?php echo $obj->idcompetencia; ?>" />    
