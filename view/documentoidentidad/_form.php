...
<form id="frm_tipocliente" >
    <input type="hidden" name="controller" value="Documentoidentidad" />

    <input type="hidden" name="action" value="save" />
    
        <input type="hidden" id="iddocumento_identidad" name="iddocumento_identidad" value="<?php echo $obj->iddocumento_identidad; ?>" />
        <br/>
